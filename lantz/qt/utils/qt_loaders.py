...
"""
    ...
    Copied with modifications from the Jupyter Project.
    https://raw.githubusercontent.com/jupyter/qtconsole/master/qtconsole/qt_loaders.py

    :copyright: IPython
    :license: BSD, see the Jupyter Project for more details.
"""
...
def import_pyqt5():
    ...
    ImportErrors rasied within this function are non-recoverable
    """
    from PyQt5 import QtCore, QtSvg, QtWidgets, QtGui, QtPrintSupport, sip
